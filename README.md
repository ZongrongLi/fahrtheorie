...
一个**纯静态**的德国驾照理论考试刷题应用：分类刷题、错题本、笔记、AI 讲解、图片题与视频题，
中英双语 + 中文译文，**所有学习数据只存在用户自己的浏览器 / 本地文件里**。

- 题库：官方目录（2025-04-01 版，2026 年 9 月仍为最新），默认只显示 **B 照 1264 题**，可切换「全部车型 2413 题」
- 单页应用，**无构建步骤、无后端、无用户账号、零服务器存储成本**
...
> 站点体积约 **24 MB**（图片 18 MB + 题目/译文 5 MB），在常见静态托管免费额度内。
